...
//Boardings subroutes
export const BOARDINGS_BASE_ROUTE = "/boardings";
...
//Crew sub routes
export const CREW_BASE_ROUTE = '/crew';
export const CREW_PAGE = "/crew/:filter";
export const VIEW_CREW_PAGE = "/crew/view/:filter";

//Vessels sub routes
export const VESSELS_BASE_ROUTE = '/vessels';
export const VESSELS_PAGE = "/vessels/:filter";
...
export const USERS_ACTIVITIES_PAGE = "/users/activities/:id";
...
//Agencies subroutes
export const AGENCIES_BASE_ROUTE = '/agencies';
