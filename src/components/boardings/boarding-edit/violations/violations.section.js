      ...
      <section>
        <div className="row">
          ...
          <div class="section-buttons">
            <Button
              variant="outlined"
              onClick={this.deleteItem.bind(this, itemNo)}
            >
        ...
        <div className="row">
          <TextField
            ...
            className="half-row"
            onChange={(e) => this.setFieldValue("description", e.target.value)}
          />
          <TextField
            label="Result of violation:"
            style={{ width: "45%" }}
            name="disposition"
            className="half-row"
            value={item.disposition}
            onChange={(e) => this.setFieldValue("disposition", e.target.value)}
          />
        </div>
      </section>
    ));
